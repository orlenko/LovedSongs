...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CrawlUrl.force_encoding'
        db.add_column('lovedmanager_crawlurl', 'force_encoding', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CrawlUrl.force_encoding'
        db.delete_column('lovedmanager_crawlurl', 'force_encoding')
